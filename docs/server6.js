    ...
    <script>
        ...
        function renderSimpleGanttChart(projects) {
            ...
            projects.forEach(project => {
                ...
                html += '<div class="gantt-no-dates">📅 Timeline coming soon - date detection in development</div>';
                html += '</div>';
                html += '</div>';
            });
            ...
            document.getElementById('ganttStatus').textContent = 
                'Timeline displayed: ' + projects.length + ' projects';
        }
