...
<head>
    ...
    <style>
        ...
        .gantt-bar.status-no-dates { background: #f59e0b; }
            position: relative;
            left: 10px;
            width: 200px;
        }
    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div id="boards-tab" class="tab-content active">
                ...
                <!-- ADD THIS GANTT SECTION HERE -->
                <div class="gantt-section" id="ganttSection" style="display: none;">
...
query {
  boards(limit: 5) {
    ...
    <script>
        ...
        let currentFilteredBoards = []; // ADD THIS LINE IF MISSING
        ...
        function applyUserFilter() {
            ...
            // Add these lines at the end of your existing applyUserFilter function:

            // Store filtered boards for Gantt chart
            currentFilteredBoards = filteredBoards;
        ...
        // GANTT CHART FUNCTIONS - Add these before the closing </script> tag
        ...
        function showGanttChart() {
            ...
            document.getElementById('ganttStatus').textContent = 'Loading simple timeline...';
        ...
        // Simple Gantt chart renderer (basic version first)
        function renderSimpleGanttChart(projects) {
            console.log('Rendering simple Gantt chart for', projects.length, 'projects');
            ...
            projects.forEach(project => {
                ...
                html += 'Items: ' + (project.items_page && project.items_page.items ? project.items_page.items.length : 0);
                html += '</div>';
                html += '</div>';
                
                html += '<div class="gantt-timeline">';
                html += '<div class="gantt-no-dates">📅 Timeline coming soon - dates will be detected from Monday.com</div>';
                html += '</div>';
                html += '</div>';
            });
            ...
            html += '<div class="gantt-legend-item"><div class="gantt-legend-color" style="background: #f59e0b;"></div>Basic Timeline (' + projects.length + ' projects)</div>';
            html += '</div>';
            ...
            document.getElementById('ganttStatus').textContent = 
                'Basic timeline: ' + projects.length + ' projects displayed';
        }
        ...
        function renderSimpleGanttChart(projects) {
            ...
            projects.forEach(project => {
                ...
                html += '<div class="gantt-project">';
                html += '<div class="gantt-project-name">📋 ' + project.name + '</div>';
                html += '<div class="gantt-project-info">Type: ' + project.board_kind + ' | Items: ' + (project.items_page && project.items_page.items ? project.items_page.items.length : 0) + '</div>';
                html += '</div>';
                html += '<div class="gantt-timeline">';
                html += '<div class="gantt-no-dates">📅 Timeline coming soon</div>';
                html += '</div></div>';
            });
            ...
            document.getElementById('showGanttBtn').style.display = 'none';
            document.getElementById('hideGanttBtn').style.display = 'inline-block';
            document.getElementById('ganttStatus').textContent = 'Basic timeline: ' + projects.length + ' projects displayed';
        }
